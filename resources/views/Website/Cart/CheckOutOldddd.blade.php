...
$(document).ready(function() {
    ...
    $(".qtyplus").click(function(e) {
        ...
        updateCart(productID, quantityInput.val(), $(this));
    });
    ...
    $(".quantity").on("change", ".qty", function() {
        ...
        updateCart(productID, $(this).val(), $(this));
    });

    function updateCart(productID, quantityValue, clickedButton) {
        $.ajax({
            ...
            success: function(response) {
                $.get(
                    "{{ route('ViewBagContent') }}?_=" + new Date().getTime(),
                    function(data) {
                        $(".NewOrderSummaryCard").html(data.data);
                ...
                $.get(
                    "{{ route('YourOrderContent') }}?_=" + new Date().getTime(),
                    function(data) {
                        $(".NewYourOrderCard").html(data.data);
                    }
                );
            ...
            error: function(xhr, status, error) {
                ...
                // Re-enable the clicked button on error too
                $(clickedButton).prop("disabled", false);
            }
        });
    }
